...
export class UtilityService {
  ...
  public handleValidationErrors(
    ...
    componentErrors: { [key: string]: string }
  ): boolean {
  ...
  public showSuccess(
    ...
    detail: string = 'Operación completada correctamente'
  ) {
  ...
  public showError(
    ...
    detail: string = 'Ha ocurrido un error inesperado'
  ) {
    this.messageService.add({
      severity: 'error',
      summary: summary,
  ...
  public showNotification(id: string, state: string) {
    this.messageService.add({
      severity: 'info',
      summary: 'Notificación recibida',
      detail: `Tu orden en ${id} se encuentra en estado ${state}`,
    });
  }
